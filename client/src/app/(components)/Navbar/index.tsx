"use client";
import { BellIcon, MenuIcon, Settings, SunIcon } from "lucide-react";
  ...
  return (
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        <button
          className="px-3 py-3 bg-gray-100 rounded-full hover:bg-blue-100 transition-all"
          onClick={() => {}}
        >
